...
#define COB_CFLAGS "-pipe -I/opt/gnucobol-3.1.2/include -Wno-unused -fsigned-char -Wno-pointer-sign"

/* Compilation of computed gotos works */
/* #define COB_COMPUTED_GOTO 1 */

/* default search path for copybooks */
#define COB_CONFIG_DIR "/opt/gnucobol-3.1.2/share/gnucobol/config"

/* default search path for configuration files */
#define COB_COPY_DIR "/opt/gnucobol-3.1.2/share/gnucobol/copy"
...
#define COB_LIBRARY_PATH "/opt/gnucobol-3.1.2/lib/gnucobol"

/* libraries passed to linker by cobc */
#define COB_LIBS "-L/opt/gnucobol-3.1.2/lib -lcob -lm"

/* long int is long long */
/* #define COB_LI_IS_LL 0 */
...
#define PACKAGE_STRING "GnuCOBOL 3.1.2"
