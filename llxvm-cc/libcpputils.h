...
std::vector<std::string> string_split2(const std::string str, const char c);
...
std::string vector_join(const std::vector<std::string> &v, std::string sep, bool ignore_empty = false);
